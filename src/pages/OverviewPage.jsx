	...
	return (
		<div className='flex-1 overflow-auto relative z-10'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
			     <StatCard name='Waste Recycling Efficiency' icon={Zap} value='25%' color='#6366F1' />
					<StatCard name='New Users' icon={Users} value='2' color='#8B5CF6' />
					<StatCard name='Total Garbage' icon={ShoppingBag} value='567' color='#EC4899' />
					<StatCard name='Cleanliness Rate' icon={BarChart2} value='12.5%' color='#10B981' />
